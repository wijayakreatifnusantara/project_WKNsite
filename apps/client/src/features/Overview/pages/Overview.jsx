              ...
              <CardContent className="p-0 flex-1 overflow-y-auto custom-scrollbar">
                <div className="p-5 relative">
                  ...
                  <div className="space-y-6">
                    <ActivityItem 
                      title="Budi Santoso Clock-in" 
                      time="Baru saja" 
                      icon={<IconCheck size={14} />} 
                      type="success" 
                      desc="Via Mobile App di Area WKN HQ"
                    />
                    <ActivityItem 
                      title="Pengajuan Lembur: Ahmad" 
                      time="10 menit lalu" 
                      icon={<IconInfoCircle size={14} />} 
                      type="info" 
                      desc="Mengajukan 4 jam lembur untuk proyek X"
                    />
                    <ActivityItem 
                      title="Siti Aminah Terlambat" 
                      time="45 menit lalu" 
                      icon={<IconClockExclamation size={14} />} 
                      type="warning" 
                      desc="Telat 15 menit dari jadwal Shift Pagi"
                    />
                    <ActivityItem 
                      ...
                      type="default" 
                      desc="Backup data kehadiran berhasil."
                    />
                  </div>
                </div>
              </CardContent>
