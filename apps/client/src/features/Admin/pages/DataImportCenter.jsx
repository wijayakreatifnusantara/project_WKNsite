      ...
      <div className="max-w-[1000px] mx-auto space-y-6 pb-20">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] mt-1">Bulk Import & Export Center</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-1 space-y-4">
            <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Target Module</h3>
              ...
              {[
                ...
                <button
                  ...
                  className={`w-full p-3 rounded-xl flex items-center gap-3 transition-all duration-300 ${
                    ...
                    ? 'bg-transparent border border-[#E31E24] shadow-sm text-[#E31E24]' 
            ...
            <Card className="border border-slate-200 bg-slate-50/50 rounded-xl shadow-sm mt-6">
              <CardContent className="p-4 space-y-2">
                <h4 className="text-xs font-black text-slate-800 uppercase tracking-widest">Format Guidelines</h4>
                ...
                <Button variant="outline" className="w-full h-8 mt-2 text-xs font-black uppercase tracking-widest border-[#E31E24] text-[#E31E24] hover:bg-red-50 hover:text-[#C1181E]">
                  Download Template
                </Button>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 flex-1 flex flex-col items-center justify-center min-h-[300px]">
                ...
                {!file ? (
                  ...
                  >
                    ...
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">or click to browse your files</p>
                    <input 
                      type="file" 
                      id="file-upload" 
                      className="hidden" 
                    ...
                    />
                    <label htmlFor="file-upload" className="cursor-pointer h-10 px-6 bg-slate-800 hover:bg-slate-700 text-white font-black text-xs uppercase tracking-widest rounded-lg shadow-sm flex items-center justify-center transition-all">
                      Browse Files
                    </label>
                    <p className="text-[11px] font-bold text-slate-400 mt-4 uppercase tracking-widest">Supported Formats: CSV, XLSX, XLS</p>
                  </div>
                ) : (
                  <div className="w-full flex flex-col items-center justify-center space-y-6">
                    <div className="w-full p-4 rounded-xl border border-slate-200 bg-slate-50 shadow-sm flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">{(file.size / 1024).toFixed(2)} KB • Ready for Import</p>
                        </div>
                      </div>
                    ...
                    {importStatus === 'success' ? (
                      <div className="p-4 rounded-xl border border-green-200 bg-green-50 text-green-700 flex flex-col items-center text-center space-y-2 w-full animate-in zoom-in duration-300">
                        ...
                        <Button onClick={() => { setFile(null); setImportStatus(null); }} className="mt-2 h-8 px-4 bg-green-600 hover:bg-green-700 text-white text-xs font-black uppercase tracking-widest rounded shadow-sm">
                          Import Another File
                        </Button>
                      </div>
                    ) : importStatus === 'error' ? (
                      <div className="p-4 rounded-xl border border-red-200 bg-red-50 text-red-700 flex flex-col items-center text-center space-y-2 w-full animate-in zoom-in duration-300">
                        ...
                        <Button onClick={() => setImportStatus(null)} className="mt-2 h-8 px-4 bg-red-600 hover:bg-red-700 text-white text-xs font-black uppercase tracking-widest rounded shadow-sm">
                          Try Again
                        </Button>
                      </div>
                    ) : (
                      <Button 
                        ...
                        className="w-full h-12 bg-[#E31E24] hover:bg-[#C1181E] text-white font-black text-[11px] uppercase tracking-widest rounded-xl shadow-sm transition-all active:scale-95"
                      >
