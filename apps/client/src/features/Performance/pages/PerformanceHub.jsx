        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex justify-between items-center mb-2 px-1">
              <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.25em]">Recent Appraisals</h3>
            ...
            {selectedReview ? (
              <Card className="border-white border-[3px] shadow-neu bg-[#f0f2f5] rounded-[2rem] p-6 animate-in slide-in-from-right-4 duration-500">
                ...
                <div className="mt-8 space-y-4">
                  {metrics.map(metric => (
                    <div key={metric.id} className="flex justify-between items-center px-4 py-3 rounded-xl bg-white/40 border border-white/50">
                ...
                {burnoutData && (
                  <div className="mt-10 pt-10 border-t-4 border-white/50 space-y-6">
              ...
              <div className="space-y-4">
                {[1, 2, 3].map(i => (
                  <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-white/40 border border-white/50">
                    ...
                    <div className="flex-1">
                      <p className="text-[10px] font-black text-slate-700 uppercase tracking-tight">Karyawan {i}</p>
                      <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Score: 4.8</p>
                    </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">{review.period}</span>
            </div>
          </div>
        </div>
