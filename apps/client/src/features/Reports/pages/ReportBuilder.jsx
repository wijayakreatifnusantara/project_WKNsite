    ...
    <div className="flex-1 overflow-y-auto p-8 bg-transparent custom-scrollbar animate-fade-in font-outfit">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <header>
          ...
          <p className="text-slate-400 text-[10px] mt-1 font-bold uppercase tracking-[0.2em]">Pusat Ekstraksi Data Master & Transaksi</p>
        </header>
                ...
                {modules.map(mod => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider mt-1">{mod.type} DATA</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <Card className={`p-6 border-white/50 shadow-neu rounded-2xl transition-all ${!selectedModObj ? 'opacity-50 pointer-events-none' : ''}`}>
              ...
              {selectedModObj?.type === 'transaction' ? (
                <div className="space-y-4">
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Tanggal Mulai</label>
                    <input 
                      type="date" 
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Tanggal Akhir</label>
                    <input 
                      type="date" 
                      value={dateRange.end}
            ...
            <Card className="p-6 border-white/50 shadow-neu rounded-2xl sticky top-8 bg-slate-800 text-white overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 mb-8">
                  <div>
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Modul Terpilih</p>
                ...
                <p className="text-[9px] text-slate-400 text-center mt-4">Peringatan: Unduhan data dilacak oleh sistem Audit Trail.</p>
              </div>
            </Card>
          </div>
        </div>
