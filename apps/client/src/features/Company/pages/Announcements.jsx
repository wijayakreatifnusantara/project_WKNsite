            ...
            <div className="space-y-4 md:col-span-2">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-white shadow-sm border-none rounded-lg focus:ring-2 focus:ring-wkn-500 focus:border-wkn-500 transition-all outline-none text-slate-800"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 bg-white shadow-sm border-none rounded-lg focus:ring-2 focus:ring-wkn-500 focus:border-wkn-500 transition-all outline-none text-slate-800 resize-none"
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 bg-white shadow-sm border-none rounded-lg focus:ring-2 focus:ring-wkn-500 outline-none"
                >
