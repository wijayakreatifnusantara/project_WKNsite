    ...
    <div className="flex-1 overflow-y-auto p-8 bg-transparent custom-scrollbar animate-fade-in">
      <div className="max-w-4xl mx-auto space-y-8">
        <header className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-[#25D366]/10 flex items-center justify-center border border-[#25D366]/30 shadow-sm">
        ...
        <Card className="bg-transparent border border-slate-200 shadow-sm rounded-xl overflow-hidden p-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-40 p-4 bg-transparent border border-slate-200 rounded-2xl shadow-sm text-sm font-bold text-slate-700 focus:outline-none focus:border-[#25D366]/50 transition-all resize-none custom-scrollbar"
              />
              <p className="text-xs font-bold text-slate-400 mt-2 ml-1">Gunakan *Teks* untuk bold, _Teks_ untuk italic (Format standar WhatsApp).</p>
            </div>
