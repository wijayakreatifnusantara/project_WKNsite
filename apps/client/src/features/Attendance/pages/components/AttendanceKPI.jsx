...
const AttendanceKPI = ({ title, value, total, unit = "", icon, color, compact = false }) => {
  ...
  if (compact) {
    return (
      <Card className="border-white border-2 shadow-sm bg-transparent rounded-2xl p-3 flex items-center gap-3 transition-all hover:translate-y-[-2px] cursor-pointer">
  ...
  return (
    <Card className="border-slate-200 border bg-transparent shadow-sm rounded-2xl p-5 transition-all hover:translate-y-[-2px] cursor-pointer group">
