...
const MiniMapModal = ({ isOpen, onClose, data }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm animate-fade-in">
      <Card className="w-full max-w-md overflow-hidden bg-white shadow-2xl rounded-2xl animate-scale-up border-0 ring-1 ring-slate-200">
        <div className="flex items-center justify-between px-5 py-4 bg-slate-50/80 backdrop-blur-md border-b border-slate-100">
